...
Se ejecuta cuando se selecciona una cantidad de millas de la lista.

```javascript
window.dataLayer = window.dataLayer || [];
window.dataLayer.push({
  event: "view_item", // Evento GA4
  ecommerce: {
    currency: "USD",
    value: value,
...
Se ejecuta cuando el usuario hace click en el botón que lo lleva a secure.
...
Se ejecuta cuando el usuario regresa de secure y cambia el valor de millas previamente seleccionado.
...
| :--- | :--- | :--- |
| `view_item.js` | view_item | Cuando se selecciona una cantidad de millas de la lista. |
